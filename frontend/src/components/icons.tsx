...
/** 统一的线性图标，使用 currentColor，可通过 size 调整尺寸。 */
...
export function CheckBadgeIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M12 3l2.2 1.6 2.7-.2 1 2.5 2.3 1.4-.6 2.7.6 2.7-2.3 1.4-1 2.5-2.7-.2L12 21l-2.2-1.6-2.7.2-1-2.5-2.3-1.4.6-2.7-.6-2.7 2.3-1.4 1-2.5 2.7.2z" />
      <path d="M9 12l2 2 4-4" />
    </svg>
  );
}
...
export function EyeOffIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M17.94 17.94A10.07 10.07 0 0112 19c-6.5 0-10-7-10-7a19.78 19.78 0 014.22-5.46M9.9 4.24A9.12 9.12 0 0112 5c6.5 0 10 7 10 7a19.8 19.8 0 01-2.92 4.19M1 1l22 22" />
...
export function TrophyIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      ...
      <path d="M6 4h12a2 2 0 012 2v3a8 8 0 01-16 0V6a2 2 0 012-2z" />
    </svg>
  );
}
