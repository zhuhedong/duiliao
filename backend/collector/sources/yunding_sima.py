...
SOURCE_ID = "yunding_sima"
SOURCE_NAME = "云顶心水四码"
SITE_FAMILY = "dingjian_dashi"
PLAY_TYPE = "tema_n"
HIT_MODE = "any"
URLS = urls_for("/api/v1/index/config/byid/1787906588716")
...
def extract(raw: str) -> list[ParsedRow]:
    ...
    for i, ln in enumerate(lines):
        ...
        chunk = ln + " " + pred_line
        nums = atoms_num(pred_line)
        xiaos = atoms_xiao(pred_line)
        atoms = nums + xiaos
...
def build(lottery: str, period: str | None, fixture: str | None):
    ...
    return build_prediction(
        ...
        empty_error=f"{SOURCE_NAME} 未提取到有效云顶心水四码预测数据",
    )
